            ...
            <div className="mt-6">
              ...
              <div className="mt-6 space-y-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full inline-flex justify-center py-2 px-4 border border-indigo-300 rounded-md shadow-sm bg-indigo-50 text-sm font-medium text-indigo-700 hover:bg-indigo-100 disabled:opacity-50"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                  </svg>
                  <span className="ml-2">Sign in with Internet Identity (ICP)</span>
                </button>
              </div>
            </div>
